...
kk = LineClient(authToken='EwavsioI4SFDbOx21Dbf.H/Mm7bFIaPhQnI/uO+q/JW.kghCbYeHl5Xgo4PNoBQT1IHiWiZagzUBxWPsgD8h3t4=')
kk.log("Auth Token : " + str(kk.authToken))
channel2 = LineChannel(kk)
kk.log("Channel Access Token : " + str(channel2.channelAccessToken))

kc = LineClient(authToken='EwlD4y728apTAvsp7Ry6.UNKe4wc3Vzi4au7QejJdvG.LwLRQkx6nzfjZNEW5cgTZ6FXE9ixDyaxVcuD0go4Yk0=')
kc.log("Auth Token : " + str(kc.authToken))
channel3 = LineChannel(kc)
kc.log("Channel Access Token : " + str(channel3.channelAccessToken))

sw = LineClient(authToken='EwYbHRSbj65mgvGm9t4e./zpGMya25+N4DDp12uoThG.en6porDjYd/tl8iyTp6cR05SSq3ByTTR5TORUVYm8oY=')
