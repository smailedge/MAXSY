...
admin = ["u4862fe4b182b2fd194a3108e2f3662e8","u4862fe4b182b2fd194a3108e2f3662e8"]
staff = ["u4862fe4b182b2fd194a3108e2f3662e8","u4862fe4b182b2fd194a3108e2f3662e8"]
...
wait = {
    ...
    "unsend":False,
    "mention":"sini lah chat jgn cuma diem aja ,didiemin itu gk enak tau...",
    ...
    try:
        ...
        for i in mid:
            ...
            if no < len(mid):
                ...
                textx += "\n「 Jumlah {} Member 」".format(str(len(mid)))
...
def siderMembers(to, mid):
    try:
        arrData = ""
        textx = "「 Tercyduk {} Reader 」\nHeiyoooh ".format(str(len(mid)))
        arr = []
        no = 1
        num = 2
        for i in mid:
...
#===========COMMAND ON OFF============#
                        ...
                        elif cmd == "เปิดติ๊ก" or text.lower() == 'sticker on':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["stickerOn"] = True
                                cl.sendText(msg.to,"เปิดระบบ ตรวจจับรหัส สติกเกอร์ เรียบร้อยแล้ว..✔")

                        elif cmd == "ปิดติ๊ก" or text.lower() == 'sticker off':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["stickerOn"] = False
                                cl.sendText(msg.to,"ปิดระบบ ตรวจจับรหัส สติกเกอร์ เรียบร้อยแล้ว..❌")
...
#===========COMMAND BLACKLIST============#
                        ...
                        elif cmd == "ban:on" or text.lower() == 'ดำคท':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["wblacklist"] = True
                                sendMention(msg.to, sender, "", "\nSend a contact to ban,\nIf done , don't forget to Refresh !")

                        elif cmd == "unban:on" or text.lower() == 'ขาวคท':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["dblacklist"] = True
                                sendMention(msg.to, sender, "", "\nSend a contact to unban,\nIf done , don't forget to Refresh !")

                        elif cmd == "banlist" or text.lower() == 'เชคดำ':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                              if wait["blacklist"] == {}:
                        ...
                        elif cmd == "blc" or text.lower() == 'คทดำ':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                              if wait["blacklist"] == {}:
