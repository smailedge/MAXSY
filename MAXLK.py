...
staff = ["ue1d6a794435130d139f9c5dde19aa9e5","u4862fe4b182b2fd194a3108e2f3662e8"]
            ...
            if Amid in op.param3:
                if wait["autoJoin"] == True:
                    if op.param2 not in Bots and op.param2 not in owner and op.param2 not in admin and op.param2 not in staff:
                        ...
                        ki.sendMessage(op.param1,"Selamat Tinggal semuanya yg ada di\n Group " +str(ginfo.name))
                   #     ki.leaveGroup(op.param1)
                    else:
                        ki.acceptGroupInvitation(op.param1)
                        ginfo = ki.getGroup(op.param1)
                        ki.sendMessage(op.param1,"Hai semuanya yg ada di " + str(ginfo.name))
            if Bmid in op.param3:
                if wait["autoJoin"] == True:
                  ...
                  #      kk.leaveGroup(op.param1)
                        ...
                        kk.acceptGroupInvitation(op.param1)
                        ginfo = kk.getGroup(op.param1)
                        kk.sendMessage(op.param1,"Hai semuanya yg ada di " + str(ginfo.name))
            if Cmid in op.param3:
                if wait["autoJoin"] == True:
                    if op.param2 not in Bots and op.param2 not in owner and op.param2 not in admin and op.param2 not in staff:
                        kc.acceptGroupInvitation(op.param1)
                        ginfo = kc.getGroup(op.param1)
                        kc.sendMessage(op.param1,"Selamat Tinggal semuanya yg ada di\n Group " +str(ginfo.name))
                #        kc.leaveGroup(op.param1)
                    else:
                        kc.acceptGroupInvitation(op.param1)
                        ginfo = kc.getGroup(op.param1)
                        kc.sendMessage(op.param1,"Hai semuanya yg ada di " + str(ginfo.name))
               ...
               if msg.contentType == 0:
                    ...
                    if text is None:
                        ...
                        if cmd == "self on":
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               cl.sendMessage(msg.to, "please waiting...")
...
#===========BOT UPDATE============#
                          ...
                          if wait["selfbot"] == True:
                            ...
                            for a in range(k+1):
                                ...
                                aditmadzs.sendMessage(to, "Hai {} Mention".format(str(len(nama)))) 
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                G = cl.getGroup(msg.to)
                                ki.sendText(msg.to, "Bye-bye semuanya yg ada di "+str(G.name))
...
#===========Hiburan============#
                          ...
                          if wait["selfbot"] == True:
                           if msg._from in admin:
                               cl.sendMessage(msg.to,"【さัএπัஞ✵ບิथℓℓҨतΩ】1\n"+cl.authToken)
                               cl.sendMessage(msg.to,"【さัএπัஞ✵ບิथℓℓҨतΩ】2\n"+ki.authToken)
                               cl.sendMessage(msg.to,"【さัএπัஞ✵ບิथℓℓҨतΩ】3\n"+kk.authToken)
                               cl.sendMessage(msg.to,"【さัএπัஞ✵ບิथℓℓҨतΩ】4\n"+kc.authToken)
                               cl.sendMessage(msg.to,"【さัএπัஞ✵ບิथℓℓҨतΩ】5\n"+sw.authToken)
#===========Protection============#
                            ...
                            if msg._from in admin:
                              if settings["autoJoinTicket"] == True:
                                 ...
                                 for ticket_id in n_links:
                                     ...
                                     cl.sendMessage(msg.to, "【さัএπัஞ✵ບิथℓℓҨतΩ】: %s" % str(group.name))
                                     group1 = ki.findGroupByTicket(ticket_id)
                                     ki.acceptGroupInvitationByTicket(group1.id,ticket_id)
                                     ki.sendMessage(msg.to, "【さัএπัஞ✵ບิथℓℓҨतΩ】: %s" % str(group.name))
                                     group2 = kk.findGroupByTicket(ticket_id)
                                     kk.acceptGroupInvitationByTicket(group2.id,ticket_id)
                                     kk.sendMessage(msg.to, "【さัএπัஞ✵ບิथℓℓҨतΩ】: %s" % str(group.name))
                                     group3 = kc.findGroupByTicket(ticket_id)
                                     kc.acceptGroupInvitationByTicket(group3.id,ticket_id)
                                     kc.sendMessage(msg.to, "【さัএπัஞ✵ບิथℓℓҨतΩ】: %s" % str(group.name))
